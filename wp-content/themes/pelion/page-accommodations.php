...
<div class="banner-full d-flex  text-center align-items-center" style="background-size:cover; background-image: url('<?php  if( get_field('banner') ): the_field('large_category'); else: echo bloginfo(home) . '/wp-content/uploads/2017/10/banner-regioes.jpg';   endif;; ?>');">
   ...
   <div class="container">
      ...
      <span class="subtitle-cat text-center"><?php the_excerpt();  ?> </span>
               ...
               <div id="main">
                  <p><?php the_field('description_large' , $queried_object);?> </p>
                                  <div class="bloco-cats">
                                     ...
                                     <div class="row">
                                     <?php
                                  $the_press = new WP_Query(array('post_type' => 'accommodations','posts_per_page' => 12,'paged'=> get_query_var('paged') ));
                                        // The Loop
